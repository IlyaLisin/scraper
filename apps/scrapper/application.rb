...
module Scrapper
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['SCRAPPER_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Scrapper::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Scrapper::Action is included
      ...
      # Configure the code that will yield each time Scrapper::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Scrapper::Assets::Helpers
      end
    end
